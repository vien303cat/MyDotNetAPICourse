...
namespace HelloWorld
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine($"myFloat - mySecondFloat: {myFloat - mySecondFloat}");
            Console.WriteLine($"myDouble - mySecondDouble: {myDouble - mySecondDouble}");
            Console.WriteLine($"myDecimal - mySecondDecimal: {myDecimal - mySecondDecimal}");
...
// //  The  Program  class contains a  Main  method, which is the entry point of the application. The  Main  method writes the text "Hello World!" to the console.
//  To run the application, you can use the following command:
//  dotnet run
//  The output will be:
//  Hello World!
//  In this example, we created a simple console application that writes "Hello World!" to the console.
//  Summary
//  The  dotnet new  command is used to create a new project. The  dotnet run  command is used to run the application.
//  I hope this article was helpful. Please let me know your thoughts in the comments below.
